<template>
    <div style="text-align:left;background:#fff">
        <el-page-header @back="goBack" content="编辑商品配件报价"></el-page-header>
        ...
        <el-form :model="ruleForm"  :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
            ...
            <el-form-item label="品目编号" prop="pmbh">
                <el-input v-model="ruleForm.pmbh"></el-input>
            </el-form-item>
            <el-form-item label="品目名称" prop="pmmc">
                <el-input v-model="ruleForm.pmmc"></el-input>
            </el-form-item>

            <el-form-item label="型号编号" prop="xhbh">
                <el-input v-model="ruleForm.xhbh"></el-input>
            </el-form-item>
            <el-form-item label="型号名称" prop="xhmc">
                <el-input v-model="ruleForm.xhmc"></el-input>
            </el-form-item>

            <el-form-item label="配件编号" prop="pjbh">
                <el-input v-model="ruleForm.pjbh"></el-input>
            </el-form-item>
            <el-form-item label="配件名称" prop="pjmc">
                <el-input v-model="ruleForm.pjmc"></el-input>
            </el-form-item>

            <el-form-item label="配件价格" prop="pjjg">
                <el-input  v-model="ruleForm.pjjg"></el-input>
            </el-form-item>
