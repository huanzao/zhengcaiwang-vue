    ...
    <el-menu
      ...
      <el-submenu index="2" style="text-align:left">
        ...
        <el-menu-item-group>
          ...
          <router-link class='mymain_router' to="/main/goodsparts_offer">
              <el-menu-item index="2-2"><i class="el-icon-paperclip"></i>商品配件报价</el-menu-item>
          </router-link>
          <router-link class='mymain_router' to="/main/service">
              <el-menu-item index="2-5"><i class="el-icon-paperclip"></i>增值服务报价</el-menu-item>
          </router-link>
          <!-- <router-link class='mymain_router' to="/main/goodsModel_offer">
              <el-menu-item index="2-3"><i class="el-icon-paperclip"></i>获取商品型号信息及报价</el-menu-item>
          </router-link> -->
          <!-- <router-link class='mymain_router' to="/main/goodsSingle_offer">
              <el-menu-item index="2-4"><i class="el-icon-paperclip"></i>获取单个商品报价</el-menu-item>
          </router-link> -->
          <!-- <el-menu-item index="1-5"><i class="el-icon-paperclip"></i>撤销商品报价</el-menu-item> -->
        </el-menu-item-group>
      </el-submenu>
      ...
      <el-submenu index="3" style="text-align:left">
        ...
        <el-menu-item-group>
          ...
          <router-link class='mymain_router' to="/main/order_sure">
              <el-menu-item index="3-2"><i class="el-icon-paperclip"></i>待确认订单</el-menu-item>
          </router-link>

          <router-link class='mymain_router' to="/main/order_check">
              <el-menu-item index="3-3"><i class="el-icon-paperclip"></i>待验收订单</el-menu-item>
          </router-link>
          <router-link class='mymain_router' to="/main/order_checked">
              <el-menu-item index="3-4"><i class="el-icon-paperclip"></i>已验收订单</el-menu-item>
          </router-link>
          <router-link class='mymain_router' to="/main/order_cancel">
              <el-menu-item index="3-5"><i class="el-icon-paperclip"></i>已取消订单列表</el-menu-item>
          </router-link>
          <router-link class='mymain_router' to="/main/order_refuse">
              <el-menu-item index="3-6"><i class="el-icon-paperclip"></i>已拒绝订单列表</el-menu-item>
          </router-link>
          <router-link class='mymain_router' to="/main/order_complete">
              <el-menu-item index="3-7"><i class="el-icon-paperclip"></i>已完成订单列表</el-menu-item>
          </router-link>
      ...
      <!-- <el-submenu index="4" style="text-align:left">
        ...
        <el-menu-item-group>
          <router-link class='mymain_router' to="/main/shop">
            <el-menu-item index="4-1"><i class="el-icon-paperclip"></i>商品上/下架</el-menu-item>
          </router-link>
        </el-menu-item-group>
      </el-submenu> -->
      ...
      <!-- <el-submenu index="5" style="text-align:left">
        ...
        <el-menu-item-group>
          <el-menu-item index="4-1"><i class="el-icon-paperclip"></i>物流信息</el-menu-item>
          <el-menu-item index="4-2"><i class="el-icon-paperclip"></i>订单签收信息</el-menu-item>
          <el-menu-item index="4-3"><i class="el-icon-paperclip"></i>订单发票开具信息</el-menu-item>
          <el-menu-item index="4-3"><i class="el-icon-paperclip"></i>收到订单发票时间</el-menu-item>
          <el-menu-item index="4-3"><i class="el-icon-paperclip"></i>订单收款情况</el-menu-item>
          <el-menu-item index="4-3"><i class="el-icon-paperclip"></i>推送商品唯一标码</el-menu-item>
        </el-menu-item-group>
      </el-submenu> -->
      <!-- <el-submenu index="6" style="text-align:left">
        ...
        <el-menu-item-group>
          <router-link class='mymain_router' to="/main/contrast"><el-menu-item index="6-1"><i class="el-icon-paperclip"></i>价格对比</el-menu-item></router-link>
        </el-menu-item-group>
      </el-submenu> -->
    </el-menu>
  </el-col>   
